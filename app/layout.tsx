        ...
        >
          ...
          <Dialog open={open} onOpenChange={setOpen} modal={true}>
            <DialogContent className="sm:max-w-[500px]">
              <DialogHeader>
                <DialogTitle className="text-2xl font-bold tracking-tight text-center">CONTENT FOR OVER 18+ ONLY</DialogTitle>
                <DialogDescription className="text-center">
                  This Website is for use solely by individuals who are at least 18 years old and have reached the age of
                  majority.
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-4 text-sm">
                ...
                <p className="text-muted-foreground text-xs">Date: {currentDate}</p>
              </div>
              <DialogFooter className="flex-col gap-2 sm:flex-row sm:justify-center sm:space-x-4">
                ...
                <Button type="button" variant="outline" className="w-full sm:w-auto border-gray-600" onClick={handleDisagree}>
                  I DISAGREE
                </Button>
              </DialogFooter>
            </DialogContent>
